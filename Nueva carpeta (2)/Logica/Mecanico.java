	...
	public void completarInforme(Informe informe) {
		...
		case "restauracion":
			...
			case 1:
				...
				material += ("Aleacion de hierro");
				break;
			case 2:
				JOptionPane.showMessageDialog(null,"Se agrego Aleacion de aluminio");
				material += ("Aleacion de aluminio");
				
				break;
			case 3:
				JOptionPane.showMessageDialog(null,"Se agrego Aleacion de magnesio");
				material += ("Aleacion de magnesio");
				
				break;
			case 4:
				JOptionPane.showMessageDialog(null,"Se agrego Plasticos");
				material += ("Plasticos");
				
				break;
				
			case 5:
				JOptionPane.showMessageDialog(null,"Se agrego cristales");
				material += ("cristales");
				break;
			default:
