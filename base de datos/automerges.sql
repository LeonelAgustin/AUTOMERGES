...
CREATE TABLE IF NOT EXISTS `Automerges`.`empleado` (
  ...
  `horario_entrada` VARCHAR(8) NULL,
  `horario_salida` VARCHAR(8) NULL,
...
CREATE TABLE IF NOT EXISTS `Automerges`.`informe` (
  ...
  `materiales` VARCHAR(50) NULL DEFAULT 'null',
...
CREATE INDEX `fk_informe_Pieza1_idx` ON `Automerges`.`informe` (`Pieza_Numero_de_pieza` ASC);
