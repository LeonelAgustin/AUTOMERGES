...
public class Loginux extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8641082045595606690L;
	...
	public Loginux() {
		...
		JLabel lblNewLabel = new JLabel("Contrase"+ni+"a");
		...
		lblNewLabel_2.setFont(new Font("Roboto Medium", lblNewLabel_2.getFont().getStyle(), lblNewLabel_2.getFont().getSize() + 2));
		...
		lblNewLabel_2_1.setFont(new Font("Roboto Medium", lblNewLabel_2_1.getFont().getStyle(), lblNewLabel_2_1.getFont().getSize() + 2));
