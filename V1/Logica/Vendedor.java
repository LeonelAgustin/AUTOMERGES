...
public class Vendedor extends Persona {
    ...
    public Informe vendedor(Vehiculo vehiculo ,Pieza pieza,Cliente cliente) {
		final String tipo_de_empleado[]={"Comprar auto","Vender auto","Comprar pieza","Vender pieza","Reparar auto"};
